...
export class AttackProcessor {
  ...
  private getAvailableModes(character: Partial<Character>, weapon: ItemWeapon): ItemWeaponMode[] {
  ...
  private getWeaponSkill(character: Partial<Character>, weapon: ItemWeapon): CharacterSkill | undefined {
